...
Unreal Engine, DirectX, WinAPI 환경에서 진행한 프로젝트와  
개발 과정, Runtime 결과, 기술 정리를 관리합니다.
...
- Focus: Gameplay System · Rendering · Client Architecture · Engine Structure
...
[Youngki Jeong | Game Dev Lab](https://notion-blog-nextjs-ten.vercel.app/)
...
| # | Project | Stack | Focus |
|---|---|---|---|
| 01 | [Rite Seekers](Projects/01_RiteSeekers/README.md) | Unreal Engine 5 / GAS | Gameplay Framework · Combat System |
| 02 | [DX11 SpongeBob BFBB](Projects/02_DX11-SpongeBob-BFBB/README.md) | DirectX11 / C++ | Rendering Pipeline · Client Architecture |
| 03 | [Imitation Trigger](Projects/03_ImitationTrigger/README.md) | Unreal Engine / C++ | Camera Integration · Gameplay State |
